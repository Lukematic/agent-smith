...
Working history: this project shipped as "A.W.I.N.O."; only the deprecated `smith` console
command is kept for compatibility (see docs/MISSION.md). Every
...
this file so that ``from awino import cli; cli.app`` has every command
...
from awino import debugging, seeds, skill_catalog
from awino.enforce import Gate, Ledger, LedgerError
from awino.knowledge import KnowledgeStore
from awino.paths import AwinoPaths, Workspace
...
from awino.cli import brief, buddy, dispatch, gate, install, knowledge, loopctl, maintain, project, proof  # noqa: E402

app.add_typer(buddy.buddy_app, name="buddy")
app.add_typer(loopctl.loop_app, name="loop")
app.add_typer(proof.proof_app, name="proof")

del brief, buddy, dispatch, gate, install, knowledge, loopctl, maintain, project, proof
