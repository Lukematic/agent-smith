...
from awino.validate import BROKEN_SELFTEST, Status, discover, validate_file, validate_text
...
def delegate_command(
    ...
    if dry_run:
        _echo("DRY_RUN  prompts written to .awino/assignments/, nothing spawned")
        return
...
def _resume_block(workspace, session_id: str) -> str:
    ...
    from awino import machine as _machine
