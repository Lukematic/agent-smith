...
from awino.mission import Confidence, Mission
from awino.paths import project_state_dir

ONBOARDING_FILE = ".awino/project.yaml"  # relative name; see path_for()
...
def path_for(project: Path) -> Path:
    """Where the onboarding record lives; migrates a legacy ``.smith/`` first."""
    return project_state_dir(project) / "project.yaml"
