...
from awino.enforce import MAX_ATTEMPTS, Ledger, ProvenanceGateResult, ReviewVerdict
from awino.spawn import Assignment, Role, Runner, SpawnResult, current_depth, spawn_one, verify
...
def run_worker_reviewer_graph(
    ...
    *,
    ...
    for number in range(1, budget + 1):
        ...
        worker = execute(worker_assignment, awino_home, project, runner)
        ...
        reviewer = execute(reviewer_assignment, awino_home, project, runner)
